...
function WOPage({workOrders,setWorkOrders,vehicles,generators,canEdit}){
...
function VendorsPage({vendors,setVendors,canEdit}){
  ...
  const defForm={name:"",type:"Service",phone:"",email:"",contact:"",city:""};
  const [form,setForm]=useState(defForm);
  ...
  return(<div style={{minHeight:"100vh",background:"#F7F8FC",fontFamily:"'DM Sans',system-ui,sans-serif"}}><link href="https://fonts.googleapis.com/css2?family=DM+Sans:wght@400;500;600;700&display=swap" rel="stylesheet"/>
    ...
    <main style={{marginLeft:sw,padding:mob?"14px 10px":"20px 24px",transition:"margin-left 0.2s",minHeight:"calc(100vh - 56px)"}}>
      <Routes>
        ...
        <Route path="/workorders" element={<WOPage workOrders={workOrders} setWorkOrders={setWorkOrders} vehicles={vehicles} generators={generators} canEdit={canEdit}/>}/>
        ...
        <Route path="/vendors" element={<VendorsPage vendors={vendors} setVendors={setVendors} canEdit={canEdit}/>}/>
        ...
        <Route path="/settings" element={<SettingsPage locations={locations} setLocations={setLocations} users={users} setUsers={setUsers} user={user} setUser={setUser}/>}/>
